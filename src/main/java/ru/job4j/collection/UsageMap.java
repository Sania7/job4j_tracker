...
public class UsageMap {
    public static void main(String[] args) {
        ...
        for (String key : map.keySet()) { // метод keySet возвращает коллекцию состоящую только из ключей
            String value = map.get(key); // Через метод get мы получаем значение ассоциированное с этим ключом
        ...
        // Важно помнить, что объект key должен правильно реализовывать метод equals, иначе Map работать не будет.
